...
CREATE TABLE `goods_order` (
  `order_id` varchar(100) NOT NULL COMMENT '订单标识',
  `order_name` varchar(100) DEFAULT NULL COMMENT '订单名称',
  `u_id` int(10) DEFAULT NULL COMMENT '用户标识',
  `u_name` varchar(100) DEFAULT NULL COMMENT '用户名称',
  ...
  `trade_status` int(10) NOT NULL COMMENT '',
  `u_phone` varchar(100) DEFAULT NULL COMMENT '用户手机',
  `u_mail` varchar(100) DEFAULT NULL COMMENT '用户邮箱',
  `trade_num` int(100) DEFAULT NULL COMMENT '交易数量',
  `source` varchar(100) DEFAULT NULL COMMENT '创建来源： pc   h5  android  ios',
